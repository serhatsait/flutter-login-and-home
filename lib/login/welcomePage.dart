...
import 'package:serhatsaitpekediz/home.dart';
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            boxShadow: <BoxShadow>[
              BoxShadow(
                  color: Color(0xff2d9a59).withAlpha(100),
                  offset: Offset(2, 4),
                  blurRadius: 8,
                  spreadRadius: 2)
            ],
        ...
        child: Text(
          'Giriş Yap',
          style: TextStyle(fontSize: 20, color: Color(0xff2d9a59)),
        ),
      ),
    );
  }
